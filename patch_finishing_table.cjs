...
content = content.replace(/<div>\s*<h5 className="font-medium text-slate-700 mb-2 text-sm">تأكيد أعداد التشطيب الفعلية السليمة:<\/h5>[\s\S]*?<\/table>\s*<\/div>\s*<\/div>/, replacement);
