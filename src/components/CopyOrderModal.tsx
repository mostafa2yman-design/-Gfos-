...
export function CopyOrderModal({ isOpen, onClose, onSelect, currentOrderId }: CopyOrderModalProps) {
    ...
    <div className="fixed inset-0 bg-slate-900/50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-xl shadow-xl w-full max-w-2xl flex flex-col max-h-[85vh]">
        <div className="flex items-center justify-between p-6 border-b border-slate-200">
          <h2 className="text-xl font-bold text-slate-800">نسخ بيانات أمر إنتاج سابق</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 border-b border-slate-100">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="البحث برقم الأمر، القصة، أو اسم العميل..."
              value={search}
