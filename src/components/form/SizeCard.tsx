      ...
      <div className="bg-white px-5 py-4 border-b border-slate-200 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">إجمالي المقاس: <span className="font-bold text-indigo-600">{sizeTotal}</span> قطعة</p>
          </div>
        </div>
          ...
          {sizeData.variants.length > 0 && availableSizesToCopy.length > 0 && (
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 text-sm bg-white border border-slate-300 text-slate-700 hover:bg-slate-50 rounded-md transition-colors font-medium"
              >
